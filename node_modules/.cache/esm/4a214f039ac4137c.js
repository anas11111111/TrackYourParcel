let express,configure,handleErrors,connectWithDb;_9ac‍.w("express",[["default",["express"],function(v){express=v}]]);_9ac‍.w("./controllers/index",[["default",["configure"],function(v){configure=v}]]);_9ac‍.w("./middlewares/handleErrors",[["handleErrors",["handleErrors"],function(v){handleErrors=v}]]);_9ac‍.w("./mongo",[["default",["connectWithDb"],function(v){connectWithDb=v}]]);
...
app.listen(port, () => {
    _9ac‍.g.console.log("listening to port no:" + port)
})
//log(models);
